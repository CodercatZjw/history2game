...
export const portraitAssets = {
  ...
  geshuHan: publicAsset("portraits/chen-xuanli.png"),
  yangGuifei:
  ...
  yangGuozhong: publicAsset("portraits/yang-guozhong.png"),
  gaoLishi: publicAsset("portraits/gao-lishi.png"),
  chenXuanli: publicAsset("portraits/chen-xuanli.png"),
  liHeng: publicAsset("portraits/li-heng.png"),
  yanZhuang: publicAsset("portraits/yan-zhuang.png"),
  fieldOfficer: publicAsset("portraits/field-officer.png"),
  scout: publicAsset("portraits/scout.png"),
  soldier: publicAsset("portraits/soldier.png"),
  minister: publicAsset("portraits/yang-guozhong.png")
};

export const endingAssets = {
  historyReenacted: publicAsset("endings/ending-history-reenacted.jpg"),
  tongguanHeld: publicAsset("endings/ending-tongguan-held.jpg"),
  politicalFailure: publicAsset("endings/ending-political-failure.jpg"),
  maweipoExpanded: publicAsset("endings/ending-maweipo-expanded.jpg"),
  yangSurvives: publicAsset("endings/ending-yang-survives.jpg"),
  suzongPower: publicAsset("endings/ending-suzong-power.jpg"),
  anExpanded: publicAsset("endings/ending-an-expanded.jpg"),
  reformCostly: publicAsset("endings/ending-reform-costly.jpg")
};
