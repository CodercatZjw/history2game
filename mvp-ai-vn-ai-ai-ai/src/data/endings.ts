...
import { endingAssets } from "./assets";
...
export const endings: EndingDefinition[] = [
  {
    ...
    backgroundImage: endingAssets.historyReenacted,
    closeoutLines: [
      {
        id: "end-history-1",
        speaker: null,
  ...
  },
  {
    ...
    backgroundImage: endingAssets.tongguanHeld,
    closeoutLines: [
      {
        id: "end-tongguan-1",
        speaker: null,
  ...
  },
  {
    ...
    backgroundImage: endingAssets.politicalFailure,
    closeoutLines: [
      {
        id: "end-political-1",
        speaker: null,
  ...
  },
  {
    ...
    backgroundImage: endingAssets.maweipoExpanded,
    closeoutLines: [
      {
        id: "end-mutiny-1",
        speaker: null,
  ...
  },
  {
    ...
    backgroundImage: endingAssets.yangSurvives,
    closeoutLines: [
      {
        id: "end-yang-1",
        speaker: null,
  ...
  },
  {
    ...
    backgroundImage: endingAssets.suzongPower,
    closeoutLines: [
      {
        id: "end-suzong-1",
        speaker: null,
  ...
  },
  {
    ...
    backgroundImage: endingAssets.anExpanded,
    closeoutLines: [
      {
        id: "end-an-1",
        speaker: null,
  ...
  },
  {
    ...
    backgroundImage: endingAssets.reformCostly,
    closeoutLines: [
      {
        id: "end-reform-1",
        speaker: null,
