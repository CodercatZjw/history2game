...
export function DialogueBox({ line, phase, canContinue, onContinue, compact = false, thinkingName = null }: DialogueBoxProps) {
  ...
  return (
    ...
    >
      ...
      {thinkingName && (
        <div className="mt-3 flex items-center gap-2 rounded-md border border-amber-100/20 bg-black/28 px-3 py-2 text-sm text-amber-100">
          <span>{thinkingName}正在思考</span>
          <span className="thinking-dots inline-flex w-6 items-center" aria-hidden="true">
            <span>.</span>
            <span>.</span>
            <span>.</span>
          </span>
